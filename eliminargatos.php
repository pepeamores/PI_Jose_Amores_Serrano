...
if (isset($_SESSION["esAdmin"])) {
    ...
    print "<h2>Lista Gatos</h2>";
    $resultado = mysqli_query($conexion, "SELECT * FROM gatos");
    ...
    echo $tabla;
    ?>
    <form name='formulario' action='eliminargatos.php' method='POST' enctype='multipart/form-data'>
    <label for="id">Introduce un ID:</label>
            <input type="text" id="id" name="id" min='1'  value='1' ><br><br>
            <button type='submit' name='enviar'>Eliminar Gatos</button>
    </form>
