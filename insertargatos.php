        ...
        <div class="row">
            <div class="col-md-12">
                ...
                if (isset($_SESSION["esAdmin"])) {
                    ?>
                    <form name="formulario" action="validargatos.php" method="POST" enctype="multipart/form-data">
...
<br><br>
                        <label for="imagen">Foto Gatos:</label>
                        <input type="file" id="imagen" name="imagen"><br><br>
                        <label for="descripcion">Descripción:</label>
                            <button type="submit" name="enviar">Insertar Gatos</button>
                    </form>
