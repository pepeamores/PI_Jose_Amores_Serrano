...
<head>
    <title>Insertar Protectoras</title>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                if (isset($_SESSION["esAdmin"])) {
                    ?>
                    <form name="formulario" action="validarprotectora.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" id="telefono" name="telefono" required><br><br>
                            <button type="submit" name="enviar">Insertar Protectoras</button>
                    </form>
